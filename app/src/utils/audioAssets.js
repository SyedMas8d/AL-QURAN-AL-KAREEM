...
export const getAudioSource = (audioPath) => {
    ...
    const audioRequireMap = {
        ...
        '/assets/audios/adkhars/DUA_MRN_EVE_YAAHAYYU.mp3': require('../../assets/audios/adkhars/DUA_MRN_EVE_YAAHAYYU.mp3'),
        '/assets/audios/adkhars/DUA_EVEN_ADKHAR.mp3': require('../../assets/audios/adkhars/DUA_EVEN_ADKHAR.mp3'),
        '/assets/audios/adkhars/DUA_EVEN_ADKHAR.mp3': require('../../assets/audios/adkhars/DUA_EVEN_ADKHAR.mp3'),
